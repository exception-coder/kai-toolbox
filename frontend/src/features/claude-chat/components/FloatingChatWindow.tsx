  ...
  return (
    ...
    >
      ...
      {!compact && (showMore ? (
        ...
        <MessageList sessionKey={chat.sessionId ?? undefined} items={chat.items} running={chat.running} onFork={chat.forkSession} engineLabel={engineLabel} onCleanRetry={chat.cleanRetry} turnTokens={chat.turnTokens} connState={chat.state} />
      ))}
