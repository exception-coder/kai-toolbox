...
public sealed interface ServerMessage
    ...
    @JsonTypeName("ready")
    record Ready(long seq, String sessionId, String sdkSessionId, List<String> slashCommands, String status, String epoch, String engine) implements ServerMessage {}
