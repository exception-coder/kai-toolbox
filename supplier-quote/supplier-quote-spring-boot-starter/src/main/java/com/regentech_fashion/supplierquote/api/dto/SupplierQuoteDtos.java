...
public final class SupplierQuoteDtos {
    ...
    public record BindingView(String scmUserId, String username, String displayName,
    ...
    public record WechatSessionView(boolean authenticated, boolean bound, String authorizeUrl,
                                    BindingView binding) {}
    public record ScmBindingRequest(@NotBlank String username, @NotBlank String password, String returnTo) {}
    public record ScmBindingResult(BindingView binding, String returnTo) {}
