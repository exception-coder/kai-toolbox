...
import { evaluationHref, useAgentNavigation, type AgentDetailTab } from "../navigation";
...
export function AgentRegistryView() {
  ...
  const { agentId, tab, selectAgent, selectTab: setTab } = useAgentNavigation();
      ...
      <div className="mt-6 border-y border-slate-200">
        <div className="flex flex-wrap items-end justify-between gap-3 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to={evaluationHref(snapshot.id, dataset?.id)}
