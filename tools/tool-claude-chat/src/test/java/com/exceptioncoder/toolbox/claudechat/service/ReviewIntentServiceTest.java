...
class ReviewIntentServiceTest {
    ...
    void completeRequirementStructureUpgradesUnknownAndExtractsBusinessDraft() {
        ...
        ReviewIntentAssessment result = fixture.service.validateAfterReply(
                "review-session", "turn-3", response).orElseThrow();
        ...
        assertThat(result.extractedContent()).contains("评审页面只展示业务对话");
    ...
    private Fixture fixture() {
        ...
        return new Fixture(classifier, repository, new ReviewIntentService(classifier, repository, spaces));
    }
