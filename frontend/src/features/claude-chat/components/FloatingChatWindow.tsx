  ...
  return (
    ...
    >
      ...
      {!compact && (showSessions ? (
        ...
        <MessageList items={chat.items} running={chat.running} onFork={chat.forkSession} engineLabel={engineLabel} onResumeCurrent={chat.resumeCurrent} turnTokens={chat.turnTokens} />
      ))}
